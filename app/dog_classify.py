...
def predict_image(img_path):
    ...
    if dog_detector(img_path):
        print("The image you provided looks like an %s." % dog_breed_predicted)
    elif face_detector(img_path):
        print("The image you provided is a human.")
    else:
        print("The image you provided is neither a dog nor a human.")
...
def displayImage():
"""
Adapted from https://thinkinfi.com/upload-and-display-image-in-flask-python/?utm_content=cmp-true
"""  
